...
def test_verify_cshd(caplog, verify_cshd_2failed_files):
    ...
    x_contains_all_y(caplog.record_tuples, [
        ('checksum_helper.checksum_helper', logging.INFO, 'new_cshd.txt: SHA512 OK'),
...
def test_verify_hfile_warn_beyond_root_and_wrong_crc(caplog):
    ...
    x_contains_all_y(caplog.record_tuples, [
        ...
        ('checksum_helper.checksum_helper', logging.INFO, f'file1.txt: SHA512 OK'),
    ])
...
def test_verify_hfile_warn_missing(caplog):
    ...
    assert starting_cwd == os.getcwd()
    x_contains_all_y(caplog.record_tuples, [
        ('checksum_helper.checksum_helper', logging.INFO, f'new 2.txt: SHA512 OK'),
...
def test_verify_hfile_successful(caplog):
    ...
    x_contains_all_y(caplog.record_tuples, [
        ('checksum_helper.checksum_helper', logging.INFO, f'new 2.txt: SHA512 OK'),
        ('checksum_helper.checksum_helper', logging.INFO, f'new 3.txt: SHA512 OK'),
        ('checksum_helper.checksum_helper', logging.INFO, f'new 4.txt: SHA512 OK'),
    ])
    assert caplog.record_tuples[-3] == ('checksum_helper.checksum_helper', logging.INFO,
...
def test_verify_hfile_warn_missing_and_crc(caplog):
    ...
    x_contains_all_y(caplog.record_tuples, [
        ...
        ('checksum_helper.checksum_helper', logging.INFO, f'sub1{os.sep}new 3.txt: SHA512 OK'),
        ('checksum_helper.checksum_helper', logging.INFO, f'sub1{os.sep}new 4.txt: SHA512 OK'),
        ('checksum_helper.checksum_helper', logging.INFO,
...
def test_verify_all(caplog):
    ...
    x_contains_all_y(caplog.record_tuples, [
        ...
        ('checksum_helper.checksum_helper', logging.WARNING,
         f'sub6{os.sep}file1.txt: MISSING'),
        ('checksum_helper.checksum_helper', logging.INFO, f'new_cshd.txt: SHA512 OK'),
        ('checksum_helper.checksum_helper', logging.WARNING,
         f'sub1{os.sep}new_cshd_3.txt: SHA512 FAILED -> OUTDATED HASH (file is newer)'),
        ('checksum_helper.checksum_helper', logging.WARNING,
         f'sub2{os.sep}new_cshd_missing.txt: MISSING'),
